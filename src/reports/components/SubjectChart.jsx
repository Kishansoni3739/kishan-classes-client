...
export function SubjectChart({ subjectStats }) {
  ...
  return (
    <div className="rounded-2xl border border-[#e2e8f0] p-4 bg-[#ffffff] h-[220px]">
      <h4 className="mb-2 text-base font-semibold text-[#334155]">Subject-wise Average Performance</h4>
      <div className="h-[150px] w-full">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={subjectStats} margin={{ top: 10, right: 10, left: -20, bottom: 20 }}>
            ...
            <Bar dataKey="averagePercent" radius={[6, 6, 0, 0]} name="Average Score (%)" isAnimationActive={false}>
