  ...
  if (user.role === "student") {
    return (
      ...
      <section className="space-y-6">
        <Header title={`Student Dashboard: ${user.name}`} subtitle="Profile, fees, recent results, materials, and notices." />
            ...
            <DashboardList 
              ...
              render={(item) => (
                <div className="space-y-2 w-full">
                  <div className="flex justify-between items-center w-full">
                    <span className={`px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-wider rounded-md ${
                      item.category === "behavioral" ? "bg-amber-100 text-amber-700" : "bg-indigo-100 text-indigo-700"
                    }`}>
                      {item.category}
                    </span>
